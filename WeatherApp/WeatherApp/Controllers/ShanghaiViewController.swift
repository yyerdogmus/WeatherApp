...
class ShanghaiViewController: UIViewController {
    ...
    func  setupUI(){
        ...
        let shangahiImage = UIImageView()
        view.addSubview(shangahiImage)
        shangahiImage.image = UIImage(named: "Shanghai")
        shangahiImage.snp.makeConstraints{ make in
